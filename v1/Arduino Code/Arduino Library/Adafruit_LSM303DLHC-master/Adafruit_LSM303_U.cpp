...
bool Adafruit_LSM303_Accel_Unified::begin()
{
        ...
        write8(LSM303_ADDRESS_ACCEL,0x20, 0b01010111);
        write8(LSM303_ADDRESS_ACCEL,0x23, 0b00001000);
        write8(LSM303_ADDRESS_ACCEL,0x21, 0b00010001);
...
bool Adafruit_LSM303_Accel_Unified::getEvent(sensors_event_t *event) {
        ...
        //Serial.println((float)raw.x * _lsm303Accel_MG_LSB * SENSORS_GRAVITY_STANDARD);
